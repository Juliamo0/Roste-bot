"""
1) ตัด ref_rvc.wav จากไฟล์ต้นทาง (191.7s → 198.5s ≈ 6.8 วิ)
...
REF_OUT    = os.path.join(OUT_DIR, "ref_rvc.wav")
...
# ════════════════════════════════════════════════════════════
# Step 1: ตัด ref_rvc.wav
# ════════════════════════════════════════════════════════════
print("=" * 55)
print(f"Step 1: ตัด ref_rvc.wav ({CUT_END-CUT_START:.1f} วิ)")
