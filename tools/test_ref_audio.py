...
Phase 3: ทดสอบ F5 กับ 4 refs — current + best_rvc + vachana
...
CURRENT_REF = {
    "name": "current_rvc",
    "path": os.path.join(BOT_DIR, "f5_out", "ref_rvc.wav"),
...
F5_REF_AUDIO_ORIG = os.path.join(BOT_DIR, "f5_out", "ref_rvc.wav")
...
if results:
    ...
    for test_name, _ in TESTS:
        print(f"\n  [{test_name}]:")
        print(f"    {test_name}_current_rvc_f5.wav  ← current")
        if vachana_ref_path:
