    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "ก็ตาม เช่น 'ต้องพกร่มไหม' 'พรุ่งนี้กี่องศา' 'สัปดาห์นี้ฝนตกไหม' "
                "(ไม่ใช่ get_current_time แม้มีคำว่า 'วันนี้'/'พรุ่งนี้') "
                "ห้ามใช้ถ้าผู้ใช้แค่ชวนคุย/ถามความรู้สึกโดยไม่ได้อยากรู้พยากรณ์จริง เช่น 'หนาวไหม อยากกอด' "
                "'ร้อนจังเลยเนอะ' (พูดเชิงบ่น/ชวนคุย ไม่ได้ถามอุณหภูมิจริง) — กรณีนั้นตอบแบบคนจริงไปเลย "
                "ถ้าจะเรียกจริง ห้ามเดา/ตอบจากความรู้ทั่วไปเด็ดขาด"
            ),
            "parameters": {
                "type": "object",
                "properties": {
