    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "ไม่ต้องเรียกเครื่องมือนี้ ถ้าจะเรียกจริง ห้ามเดา/ตอบจากความรู้ทั่วไปเด็ดขาด"
            ),
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "— กรณีนั้นให้ตอบเป็นความเห็น/ไอเดียของตัวเองแบบคนจริงไปเลย ไม่ต้องเรียกเครื่องมือนี้ "
