...
# หมายเหตุ: "เมื่อวาน" เคยอยู่ในลิสต์นี้แต่ตัดออก เพราะชนกับคำถามข้อมูลปัจจุบันที่เทียบกับเมื่อวาน
# บ่อยมาก เช่น "เมื่อวานฝนตกไหม เย็นนี้จะตกอีกไหม" หรือ "เมื่อวานน้ำมันเท่าไหร่" — ข้อความแบบนี้
# ไม่ได้ถามถึงบทสนทนาเก่าเลย แต่จะ trigger ดึง summary เก่ามา inject ปนกับคำถามอากาศ/น้ำมันจริง
PAST_HINTS = (
    "จำได้ไหม", "จำได้ว่า",
    "เมื่อก่อน", "เมื่อกี้",
