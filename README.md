...
- 🎤 **ร้องเพลง karaoke** — ร้องเพลง cover ด้วยเสียง Laibaht (RVC) จากโฟลเดอร์ `karaoke/`, ขอเพลงเจาะจงหรือสุ่มได้, TTS เกริ่นก่อนเล่น
...
2. แปลงด้วย RVC โมเดล Laibaht (ผ่าน `rvc_venv`)
